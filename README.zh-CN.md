...
[English](https://github.com/AIGO3fz/plotine/blob/main/README.md) | **中文**
...
功能对比评分：[`docs/MPL_GAP.md`](https://github.com/AIGO3fz/plotine/blob/main/docs/MPL_GAP.md)。
...
完整基准测试：[`docs/BENCHMARK.md`](https://github.com/AIGO3fz/plotine/blob/main/docs/BENCHMARK.md)。
...
详细对比：[`docs/MPL_GAP.md`](https://github.com/AIGO3fz/plotine/blob/main/docs/MPL_GAP.md)（英文）。
API 命名映射：[`AGENTS.md`](https://github.com/AIGO3fz/plotine/blob/main/AGENTS.md) 中的 Naming map 表。
...
| 文档 | 说明 |
|------|------|
| [`book/`](https://github.com/AIGO3fz/plotine/tree/main/book) | 用户指南 + 教程（`mdbook serve book`） |
| [`docs/MPL_GAP.md`](https://github.com/AIGO3fz/plotine/blob/main/docs/MPL_GAP.md) | 功能对比评分 vs matplotlib |
| [`docs/API_FREEZE.md`](https://github.com/AIGO3fz/plotine/blob/main/docs/API_FREEZE.md) | 0.5 → 1.0-rc API 稳定性审查 |
| [`docs/RELEASING.md`](https://github.com/AIGO3fz/plotine/blob/main/docs/RELEASING.md) | crates.io 发布流程 |
| [`docs/BENCHMARK.md`](https://github.com/AIGO3fz/plotine/blob/main/docs/BENCHMARK.md) | 基准测试设计 |
| [`CONTRIBUTING.md`](https://github.com/AIGO3fz/plotine/blob/main/CONTRIBUTING.md) | PR 规范 & 视觉审查要求 |
| [`AGENTS.md`](https://github.com/AIGO3fz/plotine/blob/main/AGENTS.md) | AI 编码助手惯用法 & 迁移指南 |
| [`CHANGELOG.md`](https://github.com/AIGO3fz/plotine/blob/main/CHANGELOG.md) | 版本历史 |

### 中文 (Chinese)

| 文档 | 说明 |
|------|------|
| [`docs/DEVELOPMENT_PLAN.md`](https://github.com/AIGO3fz/plotine/blob/main/docs/DEVELOPMENT_PLAN.md) | 顶层架构设计 & 里程碑路线图 |
| [`docs/MPL_2D_COVERAGE.md`](https://github.com/AIGO3fz/plotine/blob/main/docs/MPL_2D_COVERAGE.md) | matplotlib 静态 2D 图型覆盖清单 |

## 许可证

MIT — 见 [LICENSE](https://github.com/AIGO3fz/plotine/blob/main/LICENSE)。
内嵌 DejaVu Sans 字体保留其自有许可证（见 `crates/plotine-text/fonts/LICENSE`）。
Natural Earth 110m 海岸线数据为公共领域。
完整第三方归属：[`THIRD_PARTY_LICENSES.md`](https://github.com/AIGO3fz/plotine/blob/main/THIRD_PARTY_LICENSES.md)。
